...
class birthday extends CI_Controller{
  ...
  {
      $id_karyawan = $this->input->get('id', TRUE); //dapetin id_karyawan yg ulang tahun
      ...
      $data['get_id'] = $this->Karyawan->get_id($id_karyawan); //dapetin id_karyawan yg ulang tahun
      $data['list_ucapan'] = $this->Ucapan->showGreeting($id_karyawan);
      $data['id_beneran'] = $id_karyawan; //id_karyawan yg nulis ucapan
